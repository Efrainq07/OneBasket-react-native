...
import CryptoDateBar from '@/components/dateBar/CryptoDateBar/CryptoDateBar';
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContainer} onScroll={handleScroll} scrollEventThrottle={16}>
                ...
                <View style={styles.aboutContainer}>
                    ...
                    {isCollapsed ? <Text style={styles.content} numberOfLines={3}>{details.about?.description || `${details.name} is a leading cryptocurrency.`}</Text> : null}
                    <Collapsible collapsed={isCollapsed}>
                        <Text style={styles.content}>{details.about?.description || `${details.name} is a leading cryptocurrency.`}</Text>
                    </Collapsible>
